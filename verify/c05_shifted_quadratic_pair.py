"""C05 -- Shifted quadratic pair: n^2+n+1 and n^2+n+7 both prime.
"""
import os, sys
...
print("C05: C = %.6f  (truncation wobble %.2e)" % (C, abs(C - C_early)))
...
save_result("c05", {"conjecture": "n^2+n+1 and n^2+n+7 both prime",
