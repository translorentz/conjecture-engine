"""C02 -- Cubic shift primes: n^3 + 2.

Conjecture: #{n <= N : n^3+2 prime} ~ C2 * int dt/log(t^3+2)  (Bateman-Horn).
"""
import os, sys
...
print("C2 = %.6f  (truncation wobble %.2e)" % (C, abs(C - C_early)))
...
save_result("c02", {"conjecture": "n^3+2 prime",
