---
title: One hundred thirty-six conjectures in mathematics
---
...
**126. Scale convexity and log-concavity (Conjecture 126).** The same scale sequences are simultaneously discretely convex and log-concave, an unusually rigid coexistence with no violation in the corpus.
...
**Conjecture 129** *(Strand Hurwitz stability)*. For every $$G$$ and $$r$$ with $$H_{G,r}$$ nonconstant, every zero of $$H_{G,r}(z)/z^{\min\operatorname{supp}}$$ satisfies $$\operatorname{Re}z<0$$.
