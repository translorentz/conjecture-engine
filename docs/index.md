...
**Conjecture 195** *(The quadric ratio law with limit $$27$$)*. For even $$n$$ let $$\Sigma_n=S(Q)$$ for the all-quadric configuration of $$n+1$$ quadric equations in complex dimension $$n$$. Then $$R_n=\Sigma_{n+2}/\Sigma_n$$ is strictly increasing in $$n$$, $$R_n<27$$, and
