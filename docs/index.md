...
**53. Entropy dimension of random-free graphons (Conjecture 53).** If the row space of a $$\{0,1\}$$-valued graphon is Ahlfors $$s$$-regular then $$H(G(n,W))/(n\log n)\to s$$, the hypothesis class being nonvacuous at every $$s\in(0,2]$$ by Cantor-type threshold constructions.
