...
- **`paper/supplement_conjectures.pdf`** (`supplement_conjectures.tex`) — a
  supplement of twenty-five further structural conjectures in five
  programmes: connected prime-pattern fields, arithmetic occupancy,
  finite logarithms and tori, arboreal dynamics, and marked
  factorization processes. Its finite diagnostics are regenerated by
  `python supplement/research_quality_25_experiments.py`.
