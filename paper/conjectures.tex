...
J.~Recreational Math.\ 30 (1999--2000), 199--205.
...
\bibitem{HLS} A.~Haddad, C.~Y. Leung, and E.~Sabuncu,
...
arXiv:2111.09053 (2021).

\bibitem{PairBias} \emph{Statistical bias in the distribution of prime
pairs and isolated primes}, arXiv:1807.00406 (2018).

\bibitem{Fiori} A.~Fiori,
\emph{On the least prime in an arithmetic progression: an update},
arXiv:2404.02329 (2024).

\bibitem{Cohen} H.~Cohen,
\emph{High-precision computation of Hardy--Littlewood constants},
unpublished notes (available via OEIS A221712).
