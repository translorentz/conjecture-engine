...
is explicit); equivalently $\M_x(D_1)/\M_x(T)\to1$.  A normalization
...
Borel--Cantelli template that Conjecture~\ref{c10} exemplifies, and it fails
the naive version: our
