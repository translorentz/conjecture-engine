...
control) whose mechanism lives in \S\ref{sec:stat}.  Each slot carries
...
$4,\ 11,\ 41,\ 224,\ 1362$ at $N=10^3,\dots,10^7$ (a probable-prime
count for the quartic layer beyond $p\approx2\times10^6$; $z$ from
...
C\ref{c10} (probable-prime count for $n$ beyond about $26$):
...
C\ref{c11} (probable-prime count beyond $n\approx80$):
