...
\title{Twenty-five conjectures from a local--global random model:\\ skeleton of statements}
\author{}\date{}
\maketitle
\noindent\emph{This skeleton collects the formal statements---the twenty-five conjectures, the supporting lemma and theorem with their proofs, and the notation they require---without the surrounding discussion or verification data of the full paper.}
\section{Notation}
